...
@WebServlet(name = "CatalogBuyerServlet", value = "/catalogBuyer")
public class CatalogBuyerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Integer> lotListIdOfBuyer = lotService.getLotListIdOfBuyer(idBuyer);
        req.setAttribute("lotListIdOfBuyer", lotListIdOfBuyer);
        List<LotDto> lotList = lotService.findLotDtoForSale(LocalDate.now());
        req.setAttribute("lots", lotList);
        req.getRequestDispatcher("/catalogBuyer.jsp").forward(req, resp);
    }
